...
| TUI利用性 Checkpoint 1〜10 | [`tui-usability.md`](./tui-usability.md)、`internal/tui`、`internal/cli/tui_coordinator_test.go`、`internal/secretstore`、`internal/usersettings`、`ui/test` | AUTO PASS。protocol v4のbounded page・縦横scroll対応Changes表示、exact protocol v3 lock migrationを含む通常gate、全race、UI build、integration compileを2026-08-31に再実行。LIVE RECHECK |
