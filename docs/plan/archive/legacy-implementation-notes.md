...
- `container`: `/usr/local/bin/container`、`container CLI version 1.0.0`(リポジトリの最低要件1.2.2未満のため、1.2.2での実機統合検証は未実施)
- `opencode`: `/Users/wataru/.opencode/bin/opencode`、`1.18.16`
- GitHub API `https://api.github.com/repos/apple/container/releases/latest` の最新タグは2026-08-11確認時点で `1.2.2`
...
- GitHub API `https://api.github.com/repos/anomalyco/opencode/releases/latest` の最新タグは2026-08-11確認時点で `v1.18.16`
- linux-arm64 リリース成果物 `https://github.com/anomalyco/opencode/releases/download/v1.18.16/opencode-linux-arm64.tar.gz` は HTTP 302 で release asset に解決される
